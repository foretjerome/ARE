...
public class FiltrePeriodeTravailCalculForfaitCACIRMA
  extends FiltresTemporel
{
  ...
  {
    return ((p_temporel instanceof PeriodeTravail)) && (((p_temporel instanceof PeriodeForfaitCA)) || ((p_temporel instanceof PeriodeForfaitCIRMA)));
  }
}

/* Location:
 * Qualified Name:     FiltrePeriodeTravailCalculForfaitCACIRMA
