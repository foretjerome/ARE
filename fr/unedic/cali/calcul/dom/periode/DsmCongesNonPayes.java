...
public class DsmCongesNonPayes
  extends ObjetChronoPeriodeCalculTransient
{
  ...
  protected DsmCongesNonPayes() {}
  
  public DsmCongesNonPayes(Damj p_dateDebut, Damj p_dateFin)
  {
  ...
  {
    DsmCongesNonPayes copie = new DsmCongesNonPayes();
    copieElements(copie);
    return copie;
  }
  ...
  {
    DsmCongesNonPayes copie = (DsmCongesNonPayes)p_copie;
...
/* Location:
 * Qualified Name:     DsmCongesNonPayes
