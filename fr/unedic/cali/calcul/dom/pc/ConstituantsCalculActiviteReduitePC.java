...
public abstract class ConstituantsCalculActiviteReduitePC
  implements DomPCSpec, PersistenceCapable
{
  ...
  static
  {
    JDOImplHelper.registerClass(ConstituantsCalculActiviteReduitePC.class, jdoFieldNames, jdoFieldTypes, jdoFieldFlags, jdoPersistenceCapableSuperclass, null);
  }
  ...
  public PersistenceCapable jdoNewInstance(StateManager sm)
  {
    ...
    //   3: dup
    //   4: ldc -76
    //   6: invokespecial 95	javax/jdo/JDOFatalInternalException:<init>	(Ljava/lang/String;)V
    //   9: athrow
    //   10: areturn
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	11	0	this	ConstituantsCalculActiviteReduitePC
  ...
  public void jdoCopyFields(Object pc, int[] fieldNumbers)
  {
    ...
    ;
    ;
    if (!(pc instanceof ConstituantsCalculActiviteReduitePC)) {
...
/* Location:
 * Qualified Name:     ConstituantsCalculActiviteReduitePC
