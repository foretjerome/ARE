...
public class DecalageDureePC
  implements DomPCSpec, PersistenceCapable
{
  private transient DecalageDuree m_decalageDureeOM;
  protected Quantite m_decalageCourant;
  protected transient byte jdoFlags;
  protected transient StateManager jdoStateManager;
  private static int jdoInheritedFieldCount = 0;
  private static String[] jdoFieldNames = { "m_decalageCourant" };
  private static Class[] jdoFieldTypes = { Quantite.class };
  ...
  {
    if (m_decalageDureeOM == null) {
      m_decalageDureeOM = new DecalageDuree(this);
    }
    return m_decalageDureeOM;
  }
  
  public Quantite getDecalageCourant()
  {
    return jdoGetm_decalageCourant(this);
  }
  
  public final void setDecalageCourant(Quantite p_decalageCourant)
  {
    jdoSetm_decalageCourant(this, p_decalageCourant);
  }
  
  static
  {
    JDOImplHelper.registerClass(DecalageDureePC.class, jdoFieldNames, jdoFieldTypes, jdoFieldFlags, jdoPersistenceCapableSuperclass, new DecalageDureePC());
  }
  
  protected static final Quantite jdoGetm_decalageCourant(DecalageDureePC pc)
  {
    if (jdoFlags <= 0) {
      return m_decalageCourant;
    }
    ...
    if (sm != null)
    {
      ...
      return (Quantite)sm.getObjectField(pc, jdoInheritedFieldCount + 0, m_decalageCourant);
    }
    return m_decalageCourant;
  }
  
  protected static final void jdoSetm_decalageCourant(DecalageDureePC pc, Quantite newValue)
  {
    if (jdoFlags == 0)
    {
      m_decalageCourant = newValue;
      return;
    }
    StateManager sm = jdoStateManager;
    if (sm != null) {
      sm.setObjectField(pc, jdoInheritedFieldCount + 0, m_decalageCourant, newValue);
    } else {
      m_decalageCourant = newValue;
    }
  }
  ...
  public void jdoProvideField(int fieldNumber)
  {
    ...
    {
    case 0: 
      jdoStateManager.providedObjectField(this, fieldNumber, m_decalageCourant);
      break;
    default: 
  ...
  public void jdoReplaceField(int fieldNumber)
  {
    ...
    {
    case 0: 
      m_decalageCourant = ((Quantite)jdoStateManager.replacingObjectField(this, fieldNumber));
      break;
    default: 
      throw new JDOFatalInternalException("index of field is out of bound");
    }
  ...
  {
    DecalageDureePC pc = new DecalageDureePC();
    jdoStateManager = sm;
  ...
  public void jdoCopyFields(Object pc, int[] fieldNumbers)
  {
    ...
    for (int i = 0; i < fieldNumbers.length; i++)
    {
      ...
      {
      case 0: 
        m_decalageCourant = m_decalageCourant;
      }
    }
  }
...
/* Location:
 * Qualified Name:     DecalageDureePC
