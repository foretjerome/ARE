  ...
  extends PopulationAbstraite
{
  ...
  public PopulationRepriseStockJurisprudenceDv()
  {
    setId("IN1014943 - Jurisprudence DV".hashCode());
    setTopSelection(" ");
    setPriorite(760);
    setNombreIndividusSelectionnes(0);
    setCodeConsequenceSelection(" ");
    setLibelle("IN1014943 - Jurisprudence DV");
...
/* Location:
 * Qualified Name:     PopulationRepriseStockJurisprudenceDv
