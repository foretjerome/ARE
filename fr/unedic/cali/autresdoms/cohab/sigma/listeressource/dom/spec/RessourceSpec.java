package fr.unedic.cali.autresdoms.cohab.sigma.listeressource.dom.spec;
...
public abstract interface RessourceSpec
{
  ...
  public abstract void setNombreEnfant(int paramInt);
  
  public abstract int getNombreEnfant();
}
