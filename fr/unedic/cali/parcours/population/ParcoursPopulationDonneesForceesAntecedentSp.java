...
public class ParcoursPopulationDonneesForceesAntecedentSp
  extends ParcoursPopulationAbstraite
{
    ...
    throws ApplicativeException
  {
    ...
    while (demandesAsu.encoreSuivant())
    {
      ...
      if ((demande.estDecisionnee()) && (!demande.estEnReExamen()))
      {
        ...
        criteres.setNomPopulation("12SI2CALI_DONNEES_FORCEES_SP");
        ...
        alimenterIndividuBaseVisu(p_contexte, demande, individuPourBaseVisu, exception);
      }
    }
  ...
  private void alimenterIndividuBaseVisu(Contexte p_contexte, DemandeSpec p_demande, Individu p_individu, ApplicativeRuntimeException p_exception)
...
/* Location:
 * Qualified Name:     ParcoursPopulationDonneesForceesAntecedentSp
