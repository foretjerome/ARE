...
public class ParcoursLireAttribution
  extends ParcoursServiceAbstrait
{
    ...
    throws CoucheLogiqueException
  {
    ...
    if (individu != null)
    {
      ...
      if (Log.isTraceActive(ParcoursLireAttribution.class, Niveau.DEBUG)) {
        Log.ecritTrace(Niveau.DEBUG, ParcoursLireAttribution.class, "demarrer", "\t\t******** Début Parcours ParcoursLireAttribution ********\n");
      }
      ...
      if (Log.isTraceActive(ParcoursLireAttribution.class, Niveau.DEBUG)) {
        Log.ecritTrace(Niveau.DEBUG, ParcoursLireAttribution.class, "demarrer", "\t\t******** Résultat Parcours ParcoursLireAttribution ********\n" + resultatLireAttribution);
      }
      if (Log.isTraceActive(ParcoursLireAttribution.class, Niveau.DEBUG)) {
        Log.ecritTrace(Niveau.DEBUG, ParcoursLireAttribution.class, "demarrer", "\t\t******** Fin Parcours ParcoursLireAttribution ********\n");
      }
    }
...
/* Location:
 * Qualified Name:     ParcoursLireAttribution
