...
public abstract class RemboursementFraisIndemnisationAbstraitPC
  ...
  implements DomPCSpec, PersistenceCapable
{
  ...
  static
  {
    JDOImplHelper.registerClass(RemboursementFraisIndemnisationAbstraitPC.class, jdoFieldNames, jdoFieldTypes, jdoFieldFlags, jdoPersistenceCapableSuperclass, null);
  }
  
  protected static final int jdoGetm_etat(RemboursementFraisIndemnisationAbstraitPC pc)
  {
    if (jdoFlags <= 0) {
      return m_etat;
    }
  ...
  protected static final Quantite jdoGetm_quantiteCourante(RemboursementFraisIndemnisationAbstraitPC pc)
  {
    if (jdoFlags <= 0) {
  ...
  protected static final Quantite jdoGetm_quantiteInitial(RemboursementFraisIndemnisationAbstraitPC pc)
  {
    if (jdoFlags <= 0) {
  ...
  protected static final void jdoSetm_etat(RemboursementFraisIndemnisationAbstraitPC pc, int newValue)
  {
    if (jdoFlags == 0)
    {
      m_etat = newValue;
  ...
  protected static final void jdoSetm_quantiteCourante(RemboursementFraisIndemnisationAbstraitPC pc, Quantite newValue)
  {
    if (jdoFlags == 0)
    {
  ...
  protected static final void jdoSetm_quantiteInitial(RemboursementFraisIndemnisationAbstraitPC pc, Quantite newValue)
  {
    if (jdoFlags == 0)
    {
  ...
  public PersistenceCapable jdoNewInstance(StateManager sm)
  {
    ...
    //   0	12	0	this	RemboursementFraisIndemnisationAbstraitPC
  ...
  {
    if (!(pc instanceof RemboursementFraisIndemnisationAbstraitPC)) {
      throw new JDOFatalInternalException("Can't copy fields from a different class");
    }
    RemboursementFraisIndemnisationAbstraitPC other = (RemboursementFraisIndemnisationAbstraitPC)pc;
...
/* Location:
 * Qualified Name:     RemboursementFraisIndemnisationAbstraitPC
