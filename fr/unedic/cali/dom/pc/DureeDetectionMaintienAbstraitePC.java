...
public abstract class DureeDetectionMaintienAbstraitePC
  ...
  implements DomPCSpec, PersistenceCapable
{
  ...
  static
  {
    JDOImplHelper.registerClass(DureeDetectionMaintienAbstraitePC.class, jdoFieldNames, jdoFieldTypes, jdoFieldFlags, jdoPersistenceCapableSuperclass, null);
  }
  
  protected static final int jdoGetm_etat(DureeDetectionMaintienAbstraitePC pc)
  {
    if (jdoFlags <= 0) {
      return m_etat;
    }
  ...
  protected static final Quantite jdoGetm_quantiteCourante(DureeDetectionMaintienAbstraitePC pc)
  {
    if (jdoFlags <= 0) {
  ...
  protected static final Quantite jdoGetm_quantiteInitial(DureeDetectionMaintienAbstraitePC pc)
  {
    if (jdoFlags <= 0) {
  ...
  protected static final void jdoSetm_etat(DureeDetectionMaintienAbstraitePC pc, int newValue)
  {
    if (jdoFlags == 0)
    {
      m_etat = newValue;
  ...
  protected static final void jdoSetm_quantiteCourante(DureeDetectionMaintienAbstraitePC pc, Quantite newValue)
  {
    if (jdoFlags == 0)
    {
  ...
  protected static final void jdoSetm_quantiteInitial(DureeDetectionMaintienAbstraitePC pc, Quantite newValue)
  {
    if (jdoFlags == 0)
    {
  ...
  public PersistenceCapable jdoNewInstance(StateManager sm)
  {
    ...
    //   0	12	0	this	DureeDetectionMaintienAbstraitePC
  ...
  {
    if (!(pc instanceof DureeDetectionMaintienAbstraitePC)) {
      throw new JDOFatalInternalException("Can't copy fields from a different class");
    }
    DureeDetectionMaintienAbstraitePC other = (DureeDetectionMaintienAbstraitePC)pc;
...
/* Location:
 * Qualified Name:     DureeDetectionMaintienAbstraitePC
