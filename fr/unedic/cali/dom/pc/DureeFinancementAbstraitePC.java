...
public abstract class DureeFinancementAbstraitePC
  ...
  implements DomPCSpec, PersistenceCapable
{
  ...
  static
  {
    JDOImplHelper.registerClass(DureeFinancementAbstraitePC.class, jdoFieldNames, jdoFieldTypes, jdoFieldFlags, jdoPersistenceCapableSuperclass, null);
  }
  
  protected static final int jdoGetm_etat(DureeFinancementAbstraitePC pc)
  {
    if (jdoFlags <= 0) {
      return m_etat;
    }
  ...
  protected static final Quantite jdoGetm_quantiteCourante(DureeFinancementAbstraitePC pc)
  {
    if (jdoFlags <= 0) {
  ...
  protected static final Quantite jdoGetm_quantiteInitial(DureeFinancementAbstraitePC pc)
  {
    if (jdoFlags <= 0) {
  ...
  protected static final void jdoSetm_etat(DureeFinancementAbstraitePC pc, int newValue)
  {
    if (jdoFlags == 0)
    {
      m_etat = newValue;
  ...
  protected static final void jdoSetm_quantiteCourante(DureeFinancementAbstraitePC pc, Quantite newValue)
  {
    if (jdoFlags == 0)
    {
  ...
  protected static final void jdoSetm_quantiteInitial(DureeFinancementAbstraitePC pc, Quantite newValue)
  {
    if (jdoFlags == 0)
    {
  ...
  public PersistenceCapable jdoNewInstance(StateManager sm)
  {
    ...
    //   0	12	0	this	DureeFinancementAbstraitePC
  ...
  {
    if (!(pc instanceof DureeFinancementAbstraitePC)) {
      throw new JDOFatalInternalException("Can't copy fields from a different class");
    }
    DureeFinancementAbstraitePC other = (DureeFinancementAbstraitePC)pc;
...
/* Location:
 * Qualified Name:     DureeFinancementAbstraitePC
