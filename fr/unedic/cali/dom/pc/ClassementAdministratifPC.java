...
public abstract class ClassementAdministratifPC
  implements DomPCSpec, PersistenceCapable
{
  ...
  static
  {
    JDOImplHelper.registerClass(ClassementAdministratifPC.class, jdoFieldNames, jdoFieldTypes, jdoFieldFlags, jdoPersistenceCapableSuperclass, null);
  }
  ...
  public PersistenceCapable jdoNewInstance(StateManager sm)
  {
    ...
    //   0	11	0	this	ClassementAdministratifPC
  ...
  public void jdoCopyFields(Object pc, int[] fieldNumbers)
  {
    ...
    ;
    ;
    if (!(pc instanceof ClassementAdministratifPC)) {
...
/* Location:
 * Qualified Name:     ClassementAdministratifPC
