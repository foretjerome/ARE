...
public abstract class CapitalIndemnisationAbstraitPC
  ...
  implements DomPCSpec, PersistenceCapable
{
  ...
  static
  {
    JDOImplHelper.registerClass(CapitalIndemnisationAbstraitPC.class, jdoFieldNames, jdoFieldTypes, jdoFieldFlags, jdoPersistenceCapableSuperclass, null);
  }
  
  protected static final int jdoGetm_etat(CapitalIndemnisationAbstraitPC pc)
  {
    if (jdoFlags <= 0) {
      return m_etat;
    }
  ...
  protected static final Quantite jdoGetm_quantiteCourante(CapitalIndemnisationAbstraitPC pc)
  {
    if (jdoFlags <= 0) {
  ...
  protected static final Quantite jdoGetm_quantiteInitial(CapitalIndemnisationAbstraitPC pc)
  {
    if (jdoFlags <= 0) {
  ...
  protected static final void jdoSetm_etat(CapitalIndemnisationAbstraitPC pc, int newValue)
  {
    if (jdoFlags == 0)
    {
      m_etat = newValue;
  ...
  protected static final void jdoSetm_quantiteCourante(CapitalIndemnisationAbstraitPC pc, Quantite newValue)
  {
    if (jdoFlags == 0)
    {
  ...
  protected static final void jdoSetm_quantiteInitial(CapitalIndemnisationAbstraitPC pc, Quantite newValue)
  {
    if (jdoFlags == 0)
    {
  ...
  public PersistenceCapable jdoNewInstance(StateManager sm)
  {
    ...
    //   0	12	0	this	CapitalIndemnisationAbstraitPC
  ...
  {
    if (!(pc instanceof CapitalIndemnisationAbstraitPC)) {
      throw new JDOFatalInternalException("Can't copy fields from a different class");
    }
    CapitalIndemnisationAbstraitPC other = (CapitalIndemnisationAbstraitPC)pc;
...
/* Location:
 * Qualified Name:     CapitalIndemnisationAbstraitPC
