...
public class TestProductionPC
  implements DomPCSpec, PersistenceCapable
{
  private transient TestProduction m_testProductionOM;
  protected Damj m_dateJour;
  protected transient byte jdoFlags;
  protected transient StateManager jdoStateManager;
  private static int jdoInheritedFieldCount = 0;
  private static String[] jdoFieldNames = { "m_dateJour" };
  private static Class[] jdoFieldTypes = { Damj.class };
  ...
  public TestProductionPC()
  {
    jdoSetm_dateJour(this, null);
  }
  
  public Object createOM()
  {
    if (m_testProductionOM == null) {
      m_testProductionOM = new TestProduction(this);
    }
    return m_testProductionOM;
  }
  
  public Damj getDateJour()
  {
    return jdoGetm_dateJour(this);
  }
  
  public final void setDateJour(Damj p_dateJour)
  {
    jdoSetm_dateJour(this, p_dateJour);
  }
  
  static
  {
    JDOImplHelper.registerClass(TestProductionPC.class, jdoFieldNames, jdoFieldTypes, jdoFieldFlags, jdoPersistenceCapableSuperclass, new TestProductionPC());
  }
  
  protected static final Damj jdoGetm_dateJour(TestProductionPC pc)
  {
    if (jdoFlags <= 0) {
      return m_dateJour;
    }
    ...
    if (sm != null)
    {
      ...
      return (Damj)sm.getObjectField(pc, jdoInheritedFieldCount + 0, m_dateJour);
    }
    return m_dateJour;
  }
  
  protected static final void jdoSetm_dateJour(TestProductionPC pc, Damj newValue)
  {
    if (jdoFlags == 0)
    {
      m_dateJour = newValue;
    ...
    StateManager sm = jdoStateManager;
    if (sm != null) {
      sm.setObjectField(pc, jdoInheritedFieldCount + 0, m_dateJour, newValue);
    } else {
      m_dateJour = newValue;
    }
  }
  ...
  public void jdoProvideField(int fieldNumber)
  {
    ...
    {
    case 0: 
      jdoStateManager.providedObjectField(this, fieldNumber, m_dateJour);
      break;
    default: 
  ...
  public void jdoReplaceField(int fieldNumber)
  {
    ...
    {
    case 0: 
      m_dateJour = ((Damj)jdoStateManager.replacingObjectField(this, fieldNumber));
      break;
    default: 
      throw new JDOFatalInternalException("index of field is out of bound");
    }
  ...
  {
    TestProductionPC pc = new TestProductionPC();
    jdoStateManager = sm;
...
/* Location:
 * Qualified Name:     TestProductionPC
