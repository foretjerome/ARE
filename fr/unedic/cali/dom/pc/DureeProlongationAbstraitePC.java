...
public abstract class DureeProlongationAbstraitePC
  ...
  implements DomPCSpec, PersistenceCapable
{
  ...
  static
  {
    JDOImplHelper.registerClass(DureeProlongationAbstraitePC.class, jdoFieldNames, jdoFieldTypes, jdoFieldFlags, jdoPersistenceCapableSuperclass, null);
  }
  
  protected static final int jdoGetm_etat(DureeProlongationAbstraitePC pc)
  {
    if (jdoFlags <= 0) {
      return m_etat;
    }
  ...
  protected static final Quantite jdoGetm_quantiteCourante(DureeProlongationAbstraitePC pc)
  {
    if (jdoFlags <= 0) {
  ...
  protected static final Quantite jdoGetm_quantiteInitial(DureeProlongationAbstraitePC pc)
  {
    if (jdoFlags <= 0) {
  ...
  protected static final void jdoSetm_etat(DureeProlongationAbstraitePC pc, int newValue)
  {
    if (jdoFlags == 0)
    {
      m_etat = newValue;
  ...
  protected static final void jdoSetm_quantiteCourante(DureeProlongationAbstraitePC pc, Quantite newValue)
  {
    if (jdoFlags == 0)
    {
  ...
  protected static final void jdoSetm_quantiteInitial(DureeProlongationAbstraitePC pc, Quantite newValue)
  {
    if (jdoFlags == 0)
    {
  ...
  public PersistenceCapable jdoNewInstance(StateManager sm)
  {
    ...
    //   0	12	0	this	DureeProlongationAbstraitePC
  ...
  {
    if (!(pc instanceof DureeProlongationAbstraitePC)) {
      throw new JDOFatalInternalException("Can't copy fields from a different class");
    }
    DureeProlongationAbstraitePC other = (DureeProlongationAbstraitePC)pc;
...
/* Location:
 * Qualified Name:     DureeProlongationAbstraitePC
