...
public abstract class DureeRenouvellementAbstraitePC
  ...
  implements DomPCSpec, PersistenceCapable
{
  ...
  static
  {
    JDOImplHelper.registerClass(DureeRenouvellementAbstraitePC.class, jdoFieldNames, jdoFieldTypes, jdoFieldFlags, jdoPersistenceCapableSuperclass, null);
  }
  
  protected static final int jdoGetm_etat(DureeRenouvellementAbstraitePC pc)
  {
    if (jdoFlags <= 0) {
      return m_etat;
    }
  ...
  protected static final Quantite jdoGetm_quantiteCourante(DureeRenouvellementAbstraitePC pc)
  {
    if (jdoFlags <= 0) {
  ...
  protected static final Quantite jdoGetm_quantiteInitial(DureeRenouvellementAbstraitePC pc)
  {
    if (jdoFlags <= 0) {
  ...
  protected static final void jdoSetm_etat(DureeRenouvellementAbstraitePC pc, int newValue)
  {
    if (jdoFlags == 0)
    {
      m_etat = newValue;
  ...
  protected static final void jdoSetm_quantiteCourante(DureeRenouvellementAbstraitePC pc, Quantite newValue)
  {
    if (jdoFlags == 0)
    {
  ...
  protected static final void jdoSetm_quantiteInitial(DureeRenouvellementAbstraitePC pc, Quantite newValue)
  {
    if (jdoFlags == 0)
    {
  ...
  public PersistenceCapable jdoNewInstance(StateManager sm)
  {
    ...
    //   0	12	0	this	DureeRenouvellementAbstraitePC
  ...
  {
    if (!(pc instanceof DureeRenouvellementAbstraitePC)) {
      throw new JDOFatalInternalException("Can't copy fields from a different class");
    }
    DureeRenouvellementAbstraitePC other = (DureeRenouvellementAbstraitePC)pc;
...
/* Location:
 * Qualified Name:     DureeRenouvellementAbstraitePC
