...
public abstract class DureeIndemnisationAbstraiteGen
  extends QuantiteDroit
  implements DomGenSpec
{
  public DureeIndemnisationAbstraiteGen(DomPCSpec p_pc)
  {
    super(p_pc);
  }
  
  public DureeIndemnisationAbstraiteGen() {}
...
/* Location:
 * Qualified Name:     DureeIndemnisationAbstraiteGen
