...
public abstract class DureeRenouvellementAbstraiteGen
  extends QuantiteDroit
  implements DomGenSpec
{
  public DureeRenouvellementAbstraiteGen(DomPCSpec p_pc)
  {
    super(p_pc);
  }
  
  public DureeRenouvellementAbstraiteGen() {}
...
/* Location:
 * Qualified Name:     DureeRenouvellementAbstraiteGen
