...
public class DecorReglementaire2014
  extends DecorReglementaire
{
  public DecorReglementaire2014(Periode periodeValiditeDecor, Periode periodeValiditeDateExamenDecor, String identifiantDecor)
  {
    ...
    throws CoucheLogiqueException
  {
    ...
    {
      retour = (getPeriodeValiditeDateExamen().contient(conteneur.getDateRecherche())) && (getPeriodeValidite().contient(conteneur.getDateRecherche()));
    }
    else
    {
...
/* Location:
 * Qualified Name:     DecorReglementaire2014
