...
public class ProduitAsuCge01P04
  extends ProduitAsuAbstrait
{
  private static final long serialVersionUID = 1L;
  private static final String PRODUIT_DELEGUE = "fr.unedic.cali.asu.cge01.p04.ProduitDelegue";
  private static final String LIB_COURT = "ARE2009 CGE";
  private static final String LIB_LONG = "Produit ARE 2009 Cas général";
  ...
  private static ProduitAsuCge01P04 s_instanceUnique = null;
  
  public static ProduitAsuCge01P04 getInstance()
  {
    
    if (s_instanceUnique == null) {
      s_instanceUnique = new ProduitAsuCge01P04();
    }
  ...
  protected ProduitAsuCge01P04()
  {
    setLibelleCourt("ARE2009 CGE");
    setLibelleLong("Produit ARE 2009 Cas général");
    setPeriodeValidite(new Periode(DEBUT, FIN));
    setProduitDelegue(creerProduitDelegue("fr.unedic.cali.asu.cge01.p04.ProduitDelegue"));
    
    setCode(31);
    setNomUnique("ASU_CGE01_04");
...
/* Location:
 * Qualified Name:     ProduitAsuCge01P04
