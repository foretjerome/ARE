...
public class StrategiePriseEnCompteIccpApresPourCalcul
  implements StrategiePriseEnCompteIccpSpec
{
  ...
  public BigDecimal determinerMontantIccpALaFct(TravailSalarie p_periodeActivite, Salaire p_periodeSalaire)
  {
    ...
    if ((p_periodeActivite.getQuantiteEuroIccp() != null) && (p_periodeActivite.getQuantiteEuroIccp().getValeur() != null) && (!p_periodeActivite.getQuantiteEuroIccp().getValeur().equals(ZERO)))
    {
      montantIccp = p_periodeActivite.getQuantiteEuroIccp().getValeur();
    }
    else if ((p_periodeSalaire.getMontantIccp() != null) && (!p_periodeSalaire.getMontantIccp().getValeur().equals(ZERO)))
    {
...
/* Location:
 * Qualified Name:     StrategiePriseEnCompteIccpApresPourCalcul
