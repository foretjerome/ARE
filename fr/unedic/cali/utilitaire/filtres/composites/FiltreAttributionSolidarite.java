...
public class FiltreAttributionSolidarite
  extends FiltreCaliAbstrait
{
  private static final long serialVersionUID = 1L;
  private boolean m_filtrerDecisionValidee;
  
  public FiltreAttributionSolidarite(boolean p_estDecisionSansReexamen)
  {
  ...
  public boolean accepterElement(Temporel p_temporel)
  {
    ...
    filtreAttribution.ajouterFiltre(new FiltreDemandePourNumeroGamme(2));
...
/* Location:
 * Qualified Name:     FiltreAttributionSolidarite
