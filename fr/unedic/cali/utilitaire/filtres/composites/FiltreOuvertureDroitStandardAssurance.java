...
public class FiltreOuvertureDroitStandardAssurance
  extends FiltreCaliAbstrait
{
  ...
  public FiltreOuvertureDroitStandardAssurance(boolean p_estCompetenceAdministrativeRac, boolean p_estDecisionSansReexamen, boolean p_enleverDemandesNecessitantFinDeDroit, boolean p_filtrerParType, DemandeSpec p_demande)
  {
    m_demande = p_demande;
...
/* Location:
 * Qualified Name:     FiltreOuvertureDroitStandardAssurance
