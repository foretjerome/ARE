...
public class FiltreAttributionSurDecisions
  extends FiltreCaliAbstrait
{
  private static final long serialVersionUID = 1L;
  private boolean m_filtrerDecisionValidee;
  
  public FiltreAttributionSurDecisions()
  {
    m_filtrerDecisionValidee = false;
  }
  
  public FiltreAttributionSurDecisions(boolean p_estDecisionSansReexamen)
  {
  ...
  public boolean accepterElement(Temporel p_temporel)
  {
    ...
    boolean resultat = NaturesDecisions.estdeTypeAttribution(decision.getNatureDecision());
...
/* Location:
 * Qualified Name:     FiltreAttributionSurDecisions
