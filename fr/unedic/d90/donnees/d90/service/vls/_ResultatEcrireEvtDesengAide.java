...
public class _ResultatEcrireEvtDesengAide
  ...
  implements DataBean, Serializable, Cloneable
{
  ...
  {
    if (!(pObjet instanceof _ResultatEcrireEvtDesengAide)) {
      return false;
    }
    _ResultatEcrireEvtDesengAide x = (_ResultatEcrireEvtDesengAide)pObjet;
  ...
  {
    _ResultatEcrireEvtDesengAide clone_ResultatEcrireEvtDesengAide = new _ResultatEcrireEvtDesengAide();
    clone_ResultatEcrireEvtDesengAide.populateFrom_ResultatEcrireEvtDesengAide(this);
    return clone_ResultatEcrireEvtDesengAide;
  }
  
  public void populateFrom_ResultatEcrireEvtDesengAide(_ResultatEcrireEvtDesengAide pSource)
  {
  ...
  {
    StringBuffer s = new StringBuffer("[_ResultatEcrireEvtDesengAide");
    subToString(s);
    s.append("]");
    return s.toString();
  }
  ...
  {
    return "ResultatEcrireEvtDesengAide";
  }
...
/* Location:
 * Qualified Name:     _ResultatEcrireEvtDesengAide
