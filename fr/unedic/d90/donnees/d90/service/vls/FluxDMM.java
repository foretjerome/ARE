...
public abstract class FluxDMM
{
  public static FluxDMM getInstance()
  {
    return new _FluxDMMImpl();
  }
  ...
  public abstract String getNumeroDocument();
  
  public abstract void setNumeroDocument(String paramString);
  
  public abstract String getCodeErreurNumeroDocument();
  
  public abstract void setCodeErreurNumeroDocument(String paramString);
