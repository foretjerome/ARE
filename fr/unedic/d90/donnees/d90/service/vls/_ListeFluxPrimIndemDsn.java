...
public class _ListeFluxPrimIndemDsn
  ...
  implements DataBean, Serializable, Cloneable
{
  ...
  public _FluxPrimeIndemDsn[] getListeFluxPrimIndemDsn()
  {
  ...
  public DataList getInternalListeFluxPrimIndemDsn()
  {
  ...
  public _FluxPrimeIndemDsn getListeFluxPrimIndemDsn(int pIndex)
  {
  ...
  public void addListeFluxPrimIndemDsn(_FluxPrimeIndemDsn pElement)
  {
  ...
  public void setListeFluxPrimIndemDsn(_FluxPrimeIndemDsn[] pIn)
  {
  ...
  {
    if (!(pObjet instanceof _ListeFluxPrimIndemDsn)) {
      return false;
    }
    _ListeFluxPrimIndemDsn x = (_ListeFluxPrimIndemDsn)pObjet;
    ...
    if (getListeFluxPrimIndemDsn().length != x.getListeFluxPrimIndemDsn().length) {
      return false;
    }
    for (int i = 0; i < getListeFluxPrimIndemDsn().length; i++) {
      if ((getListeFluxPrimIndemDsn()[i] != null) && 
        (!getListeFluxPrimIndemDsn()[i].equals(x.getListeFluxPrimIndemDsn()[i]))) {
        return false;
      }
    }
    return true;
  ...
  public int hashCode()
  {
    ...
    if (m_fluxPrimeIndemDsn != null) {
      for (int i = 0; i < getListeFluxPrimIndemDsn().length; i++) {
        if (getListeFluxPrimIndemDsn()[i] != null) {
          resultat += getListeFluxPrimIndemDsn()[i].hashCode();
        }
      }
    }
    return resultat;
  ...
  {
    _ListeFluxPrimIndemDsn clone_ListeFluxPrimIndemDsn = new _ListeFluxPrimIndemDsn();
    
    clone_ListeFluxPrimIndemDsn.populateFrom_ListeFluxPrimIndemDsn(this);
    
    return clone_ListeFluxPrimIndemDsn;
  }
  
  public void populateFrom_ListeFluxPrimIndemDsn(_ListeFluxPrimIndemDsn pSource)
  {
    setListeFluxPrimIndemDsn(pSource.getListeFluxPrimIndemDsn());
  }
  
  public String toString()
  {
    StringBuffer s = new StringBuffer("[_ListeFluxPrimIndemDsn");
  ...
  protected void subToString(StringBuffer pSource)
  {
    ...
    else
    {
      ...
      for (int i = 0; i < getListeFluxPrimIndemDsn().length; i++)
      {
        ...
        pSource.append(getListeFluxPrimIndemDsn()[i]);
      }
      pSource.append("}");
    }
  }
  ...
  protected void subGoThrough(GettersHandler pHandler)
    throws Exception
  {
    DataBean[] FluxPrimeIndemDsn_Value = getListeFluxPrimIndemDsn();
    ...
    throws Exception
  {
    ...
    else
    {
      ...
      setListeFluxPrimIndemDsn(FluxPrimeIndemDsn_array);
    }
  }
  
  public String _getDatabeanName()
  {
    return "ListeFluxPrimIndemDsn";
  }
...
/* Location:
 * Qualified Name:     _ListeFluxPrimIndemDsn
