  ...
  implements DataBean, Serializable, Cloneable
{
  ...
  {
    if (!(pObjet instanceof _FluxETT)) {
      return false;
    }
    _FluxETT x = (_FluxETT)pObjet;
    if (m_nir == null)
    {
      if (m_nir != null) {
        return false;
