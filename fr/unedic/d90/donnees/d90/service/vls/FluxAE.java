...
public abstract class FluxAE
{
  public static FluxAE getInstance()
  {
    return new _FluxAEImpl();
  }
  ...
  public abstract ListeFluxPasDna getListeFluxPasDna();
  
  public abstract void setListeFluxPasDna(ListeFluxPasDna paramListeFluxPasDna);
  
  public abstract ListeFluxPasDna setNewListeFluxPasDna();
  ...
  public abstract Damj getDateDebutAGS();
  
  public abstract void setDateDebutAGS(Damj paramDamj);
  
  public abstract String getCodeErreurDateDebutAGS();
  
  public abstract void setCodeErreurDateDebutAGS(String paramString);
  
  public abstract Damj getDateFinAGS();
  
  public abstract void setDateFinAGS(Damj paramDamj);
  
  public abstract String getCodeErreurDateFinAGS();
  
  public abstract void setCodeErreurDateFinAGS(String paramString);
  
  public abstract Damj getDateDebutAdhesionRevocable();
  
  public abstract void setDateDebutAdhesionRevocable(Damj paramDamj);
  
  public abstract String getCodeErreurDateDebutAdhesionRevocable();
  
  public abstract void setCodeErreurDateDebutAdhesionRevocable(String paramString);
  
  public abstract Damj getDateFinAdhesionRevocable();
  
  public abstract void setDateFinAdhesionRevocable(Damj paramDamj);
  
  public abstract String getCodeErreurDateFinAdhesionRevocable();
  
  public abstract void setCodeErreurDateFinAdhesionRevocable(String paramString);
  
  public abstract String getIdentiteDeclaree();
  
  public abstract void setIdentiteDeclaree(String paramString);
  
  public abstract String getCodeErreurIdentiteDeclaree();
  
  public abstract void setCodeErreurIdentiteDeclaree(String paramString);
  
  public abstract String getDoute();
  
  public abstract void setDoute(String paramString);
  
  public abstract String getCodeErreurDoute();
  
  public abstract void setCodeErreurDoute(String paramString);
  ...
  public abstract BigDecimal getAncienneteMois();
  
  public abstract void setAncienneteMois(BigDecimal paramBigDecimal);
  
  public abstract String getCodeErreurAncienneteMois();
  
  public abstract void setCodeErreurAncienneteMois(String paramString);
  
  public abstract BigDecimal getAncienneteAnnee();
  
  public abstract void setAncienneteAnnee(BigDecimal paramBigDecimal);
  
  public abstract String getCodeErreurAncienneteAnnee();
  
  public abstract void setCodeErreurAncienneteAnnee(String paramString);
