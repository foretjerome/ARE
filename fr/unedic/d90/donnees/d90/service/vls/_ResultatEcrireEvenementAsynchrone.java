...
public class _ResultatEcrireEvenementAsynchrone
  ...
  implements DataBean, Serializable, Cloneable
{
  ...
  {
    if (!(pObjet instanceof _ResultatEcrireEvenementAsynchrone)) {
      return false;
    }
    _ResultatEcrireEvenementAsynchrone x = (_ResultatEcrireEvenementAsynchrone)pObjet;
  ...
  {
    _ResultatEcrireEvenementAsynchrone clone_ResultatEcrireEvenementAsynchrone = new _ResultatEcrireEvenementAsynchrone();
    clone_ResultatEcrireEvenementAsynchrone.populateFrom_ResultatEcrireEvenementAsynchrone(this);
    return clone_ResultatEcrireEvenementAsynchrone;
  }
  
  public void populateFrom_ResultatEcrireEvenementAsynchrone(_ResultatEcrireEvenementAsynchrone pSource)
  {
  ...
  {
    StringBuffer s = new StringBuffer("[_ResultatEcrireEvenementAsynchrone");
    subToString(s);
    s.append("]");
    return s.toString();
  }
  ...
  {
    return "ResultatEcrireEvenementAsynchrone";
  }
...
/* Location:
 * Qualified Name:     _ResultatEcrireEvenementAsynchrone
