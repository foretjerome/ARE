  ...
  implements DataBean, Serializable, Cloneable
{
  ...
  {
    if (!(pObjet instanceof _FluxFctDna)) {
      return false;
    }
    _FluxFctDna x = (_FluxFctDna)pObjet;
