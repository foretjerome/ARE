  ...
  implements DataBean, Serializable, Cloneable
{
  ...
  public DataList getInternalListeParametres()
  {
    return m_parametre;
  }
  ...
  {
    if (!(pObjet instanceof _ListeParametres)) {
      return false;
    }
    _ListeParametres x = (_ListeParametres)pObjet;
  ...
  {
    _ListeParametres clone_ListeParametres = new _ListeParametres();
    
    clone_ListeParametres.populateFrom_ListeParametres(this);
    
    return clone_ListeParametres;
  }
  
  public void populateFrom_ListeParametres(_ListeParametres pSource)
  {
  ...
  {
    StringBuffer s = new StringBuffer("[_ListeParametres");
...
/* Location:
 * Qualified Name:     _ListeParametres
