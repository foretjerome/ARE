...
public class ParametresRechargement
  implements IParametres
{
  private static final BigDecimal PLANCHER = BigDecimal.valueOf(30L);
  private Map<String, List<UniteAffiliation>> parametresUnite = new HashMap();
  private static IParametres instance = new ParametresRechargement();
  
  private ParametresRechargement()
  {
...
/* Location:
 * Qualified Name:     ParametresRechargement
