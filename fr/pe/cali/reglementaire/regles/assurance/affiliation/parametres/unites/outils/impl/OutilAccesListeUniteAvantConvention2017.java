...
public class OutilAccesListeUniteAvantConvention2017
  extends OutilAccesListeUniteGenerique
{
  private static final String NOM_OUTIL = "OutilAccesListeUniteAvantConvention2017";
  
  public OutilAccesListeUniteAvantConvention2017()
  {
  ...
  {
    return (estPasRechargement(criteres.getListeContextesReglementaires())) && (estPasInopposibiliteChomageInvolontaire(criteres.getListeContextesFonctionnels()));
  }
  ...
  protected boolean estPasInopposibiliteChomageInvolontaire(List<String> contextes)
  {
  ...
  {
    return new OutilAccesListeUniteAvantConvention2017();
  }
  
  public String getNomOutil()
  {
    return "OutilAccesListeUniteAvantConvention2017";
  }
}

/* Location:
 * Qualified Name:     OutilAccesListeUniteAvantConvention2017
