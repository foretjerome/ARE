...
public class OutilAccesListeUniteRechargementApresConvention2017
  extends OutilAccesListeUniteGenerique
{
  private static final String NOM_OUTIL = "OutilAccesListeUniteRechargementApresConvention2017";
  
  public OutilAccesListeUniteRechargementApresConvention2017()
  {
    List<Unite> listeUnitesGeneralRech = new ArrayList();
    listeUnitesGeneralRech.add(UniteAffiliation.HEURE_TRAVAIL);
    
    List<Unite> listeUnitesInterimaires = new ArrayList();
    listeUnitesInterimaires.add(UniteAffiliation.HEURE_TRAVAIL);
    ...
    listeUnitesAnnexe1Rech.add(UniteAffiliation.JOUR_TRAVAILLE);
    ...
    parametres.put("RG5", listeUnitesInterimaires);
  ...
  {
    return new OutilAccesListeUniteRechargementApresConvention2017();
  }
  
  public String getNomOutil()
  {
    return "OutilAccesListeUniteRechargementApresConvention2017";
  }
}

/* Location:
 * Qualified Name:     OutilAccesListeUniteRechargementApresConvention2017
