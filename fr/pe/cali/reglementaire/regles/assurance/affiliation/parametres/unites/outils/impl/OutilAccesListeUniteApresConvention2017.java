  ...
  extends OutilAccesListeUniteGenerique
{
  ...
  {
    return ((estPasRechargement(criteres.getListeContextesReglementaires())) && (estRechercheReglementApplicable(criteres.getListeContextesFonctionnels()))) || (estCouvertureDv(criteres.getListeContextesFonctionnels())) || (estInopposabiliteDv(criteres.getListeContextesFonctionnels()));
  }
  ...
  {
    return new OutilAccesListeUniteApresConvention2017();
  }
...
/* Location:
 * Qualified Name:     OutilAccesListeUniteApresConvention2017
