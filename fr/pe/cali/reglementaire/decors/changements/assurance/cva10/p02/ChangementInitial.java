package fr.pe.cali.reglementaire.decors.changements.assurance.cva10.p02;
...
public class ChangementInitial
  extends Changement
{
  private static final String NOM = "Changement Initial ASP DC";
  private static ChangementInitial instance = new ChangementInitial();
  
  private ChangementInitial()
  {
    setLibelle("Changement Initial ASP DC");
