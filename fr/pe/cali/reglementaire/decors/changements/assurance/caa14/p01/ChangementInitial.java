package fr.pe.cali.reglementaire.decors.changements.assurance.caa14.p01;
...
public class ChangementInitial
  extends Changement
{
  private static final String NOM = "Changement Initial ASR ARE";
  private static ChangementInitial instance = new ChangementInitial();
  
  private ChangementInitial()
  {
    setLibelle("Changement Initial ASR ARE");
