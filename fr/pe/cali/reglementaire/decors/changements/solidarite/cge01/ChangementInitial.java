package fr.pe.cali.reglementaire.decors.changements.solidarite.cge01;
...
public class ChangementInitial
  extends Changement
{
  private static final String NOM = "Convention Solidarité CGE";
  ...
  static
  {
    debutChangement = new Damj(2004, 1, 1);
    try
    {
  ...
  {
    setLibelle("Convention Solidarité CGE");
