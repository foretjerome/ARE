...
public abstract class AbstractManagerAppelsServicesD90
{
  ...
  public void ecrireODFAsync(CriteresEcrireODF pIn)
    throws ApplicativeException, TechniqueException
  {
    appelGeneriqueAsynchrone("Cali", "D90", "LJAVA", "LJAVA", "ecrireODF", TypeService.MISE_A_JOUR, pIn);
  }
  
  public ResultatEcrireODFOut ecrireODF(CriteresEcrireODF pIn)
    throws ApplicativeException, TechniqueException
  {
    return (ResultatEcrireODFOut)appelGeneriqueSynchrone("Cali", "D90", "LJAVA", "LJAVA", "ecrireODF", TypeService.MISE_A_JOUR, pIn, ResultatEcrireODFOut.getInstance().getClass());
  }
  
  public void ecrireEvtDesengAideAsync(CriteresEcrireEvtDesengAide pIn)
    throws ApplicativeException, TechniqueException
  {
    appelGeneriqueAsynchrone("Cali", "D90", "LJAVA", "LJAVA", "ecrireEvtDesengAide", TypeService.MISE_A_JOUR, pIn);
  }
  
  public ResultatEcrireEvtDesengAide ecrireEvtDesengAide(CriteresEcrireEvtDesengAide pIn)
    throws ApplicativeException, TechniqueException
  {
    return (ResultatEcrireEvtDesengAide)appelGeneriqueSynchrone("Cali", "D90", "LJAVA", "LJAVA", "ecrireEvtDesengAide", TypeService.MISE_A_JOUR, pIn, ResultatEcrireEvtDesengAide.getInstance().getClass());
  }
  
  public ResultatEcrireIndividu ecrireIndividu(CriteresEcrireIndividu pIn)
    throws ApplicativeException, TechniqueException
  {
    return (ResultatEcrireIndividu)appelGeneriqueSynchrone("Cali", "D90", "LJAVA", "LJAVA", "ecrireIndividu", TypeService.MISE_A_JOUR, pIn, ResultatEcrireIndividu.getInstance().getClass());
  }
  
  public void ecrireEvenementAsynchroneAsync(CriteresEcrireEvenementAsynchrone pIn)
    throws ApplicativeException, TechniqueException
  {
    appelGeneriqueAsynchrone("Cali", "D90", "LJAVA", "LJAVA", "ecrireEvenementAsynchrone", TypeService.MISE_A_JOUR, pIn);
  }
  
  public ResultatEcrireEvenementAsynchrone ecrireEvenementAsynchrone(CriteresEcrireEvenementAsynchrone pIn)
    throws ApplicativeException, TechniqueException
  {
    return (ResultatEcrireEvenementAsynchrone)appelGeneriqueSynchrone("Cali", "D90", "LJAVA", "LJAVA", "ecrireEvenementAsynchrone", TypeService.MISE_A_JOUR, pIn, ResultatEcrireEvenementAsynchrone.getInstance().getClass());
  }
...
/* Location:
 * Qualified Name:     AbstractManagerAppelsServicesD90
