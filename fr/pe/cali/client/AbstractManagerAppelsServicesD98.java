...
import fr.unedic.logique.donnees.rac.commun.dra.d98.zu.ZO98LDZJ5C;
import fr.unedic.logique.donnees.rac.commun.dra.d98.zu.ZO98LDZJ5D;
import fr.unedic.logique.donnees.rac.commun.dra.d98.zu.ZO98LDZJ5E;
import fr.unedic.logique.donnees.rac.commun.dra.d98.zu.ZO98LDZJ6F;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.impl.Log4JLogger;

public abstract class AbstractManagerAppelsServicesD98
{
  ...
  protected Object[] appelGeneriqueSynchroneAvecTableaux(String pDomaineAppelant, String pDomaineCible, String pIdImplementationAppelant, String pIdImplementationCible, String pServiceName, TypeService pTypeService, Object[] pDonnees, Class<?>[] pClasseDonneesOut)
    throws ApplicativeException, TechniqueException
  {
    ...
    return client.appelerService(configurationClient, contexteTechnique, contexteApplicatif, contexteEvenement, pDonnees, pClasseDonneesOut);
  }
  
  public SA98LD_OUT SA98LD_DUDE_Restit_INS_DUDE(ZI98LDZJ5C pIn)
    throws ApplicativeException, TechniqueException
  {
    Object[] parametres = { pIn };
    
    Class<?>[] classesDonneesOut = { ZO98LDZJ5C.getInstance().getClass(), ZO98LDZJ5D.getInstance().getClass(), ZO98LDZJ6F.getInstance().getClass(), ZO98LDZJ5E.getInstance().getClass() };
    
    Object[] out = appelGeneriqueSynchroneAvecTableaux("Cali", "D98", "LJAVA", "CICS", "ASA98LDP", TypeService.LECTURE, parametres, classesDonneesOut);
    SA98LD_OUT retour = SA98LD_OUT.getInstance();
    retour.setZO98LDZJ5C((ZO98LDZJ5C)out[0]);
    retour.setZO98LDZJ5D((ZO98LDZJ5D)out[1]);
    retour.setZO98LDZJ6F((ZO98LDZJ6F)out[2]);
    retour.setZO98LDZJ5E((ZO98LDZJ5E)out[3]);
    return retour;
  }
...
/* Location:
 * Qualified Name:     AbstractManagerAppelsServicesD98
