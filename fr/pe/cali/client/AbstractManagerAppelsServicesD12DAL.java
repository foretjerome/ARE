...
public abstract class AbstractManagerAppelsServicesD12DAL
{
  ...
  {
    return (RetourLireDALCALI)appelGeneriqueSynchrone("Cali", "D12DAL", "LJAVA", "LJAVA", "LireDALCALI", TypeService.LECTURE, pIn, RetourLireDALCALI.getInstance().getClass());
  }
  
  public void AjouterPieceJustificativeAsync(CritereAjouterPieceJustificative pIn)
    throws ApplicativeException, TechniqueException
  {
    appelGeneriqueAsynchrone("Cali", "D12DAL", "LJAVA", "LJAVA", "AjouterPieceJustificative", TypeService.MISE_A_JOUR, pIn);
  }
  
  public RetourAjouterPieceJustificative ajouterPieceJustificative(CritereAjouterPieceJustificative pIn)
    throws ApplicativeException, TechniqueException
  {
    return (RetourAjouterPieceJustificative)appelGeneriqueSynchrone("Cali", "D12DAL", "LJAVA", "LJAVA", "AjouterPieceJustificative", TypeService.MISE_A_JOUR, pIn, RetourAjouterPieceJustificative.getInstance().getClass());
  }
  
  public void SynchroniserCouleurDALAsync(CritereSynchroniserCouleurDAL pIn)
    throws ApplicativeException, TechniqueException
  {
    appelGeneriqueAsynchrone("Cali", "D12DAL", "LJAVA", "LJAVA", "SynchroniserCouleurDAL", TypeService.LECTURE, pIn);
  }
  
  public RetourSynchroniserCouleurDAL synchroniserCouleurDAL(CritereSynchroniserCouleurDAL pIn)
    throws ApplicativeException, TechniqueException
  {
    return (RetourSynchroniserCouleurDAL)appelGeneriqueSynchrone("Cali", "D12DAL", "LJAVA", "LJAVA", "SynchroniserCouleurDAL", TypeService.LECTURE, pIn, RetourSynchroniserCouleurDAL.getInstance().getClass());
  }
...
/* Location:
 * Qualified Name:     AbstractManagerAppelsServicesD12DAL
