...
import fr.pe.d12dal.service.es.completude._CritereAjouterPieceJustificative;
import fr.pe.d12dal.service.es.completude._CritereAjouterPieceJustificativeImpl;
import fr.pe.d12dal.service.es.completude._RetourAjouterPieceJustificative;
import fr.pe.d12dal.service.es.completude._RetourAjouterPieceJustificativeImpl;
...
public class AjouterPieceJustificativeConvertisseurImpl
  ...
  implements ConvertisseurInterfaceService
{
  ...
  {
    Reader rd = pLecteur;
    _CritereAjouterPieceJustificative obj = (_CritereAjouterPieceJustificative)pDeserialiseur.deserialise(_CritereAjouterPieceJustificative.class, rd);
    return new _CritereAjouterPieceJustificativeImpl(obj);
  }
  ...
  {
    Reader rd = pLecteur;
    _RetourAjouterPieceJustificative obj = (_RetourAjouterPieceJustificative)pDeserialiseur.deserialise(_RetourAjouterPieceJustificative.class, rd);
    return new _RetourAjouterPieceJustificativeImpl(obj);
  }
...
/* Location:
 * Qualified Name:     AjouterPieceJustificativeConvertisseurImpl
