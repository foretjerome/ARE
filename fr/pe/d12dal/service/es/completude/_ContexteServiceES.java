...
public class _ContexteServiceES
  ...
  implements DataBean, Serializable, Cloneable
{
  ...
  private Damj m_dateHeureCreation;
  private String m_dateHeureCreation_C_ERR;
  ...
  public void setIdFlux(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (IdFlux)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("IdFlux"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (IdFlux).");
  ...
  public void setContexteEmission(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (ContexteEmission)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("ContexteEmission"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (ContexteEmission).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
  ...
  public void setSrcCodeAssedic(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (SrcCodeAssedic)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("SrcCodeAssedic"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (SrcCodeAssedic).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
  ...
  public void setSrcCodeApplication(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (SrcCodeApplication)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("SrcCodeApplication"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (SrcCodeApplication).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
  ...
  public void setSrcCodeDomaine(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (SrcCodeDomaine)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("SrcCodeDomaine"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (SrcCodeDomaine).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
  ...
  public void setSrcCodeProcessus(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (SrcCodeProcessus)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("SrcCodeProcessus"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (SrcCodeProcessus).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
  ...
  public void setSrcCodeProgramme(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (SrcCodeProgramme)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("SrcCodeProgramme"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (SrcCodeProgramme).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
  ...
  public void setSrcCodeAgent(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (SrcCodeAgent)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("SrcCodeAgent"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (SrcCodeAgent).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
  ...
  public void setDstCodeAssedic(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (DstCodeAssedic)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("DstCodeAssedic"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (DstCodeAssedic).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
  ...
  public void setDstCodeApplication(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (DstCodeApplication)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("DstCodeApplication"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (DstCodeApplication).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
  ...
  public void setDstCodeDomaine(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (DstCodeDomaine)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("DstCodeDomaine"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (DstCodeDomaine).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
  ...
  public void setCodeActivite(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (CodeActivite)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("CodeActivite"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (CodeActivite).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
  ...
  public void setIdCourantTracker(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (IdCourantTracker)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("IdCourantTracker"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (IdCourantTracker).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
  ...
  public void setIdOrigineTracker(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (IdOrigineTracker)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("IdOrigineTracker"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (IdOrigineTracker).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
  ...
  public void setIdPrecedentTracker(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (IdPrecedentTracker)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("IdPrecedentTracker"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (IdPrecedentTracker).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
  ...
  public void setCodeFlux(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (CodeFlux)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("CodeFlux"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (CodeFlux).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
    m_codeFlux = pValeur;
  ...
  public void setEnvtNature(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (EnvtNature)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("EnvtNature"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (EnvtNature).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
  ...
  public void setEnvtBase(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (EnvtBase)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("EnvtBase"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (EnvtBase).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
    m_envtBase = pValeur;
  ...
  public void setEnvtServeur(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (EnvtServeur)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("EnvtServeur"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (EnvtServeur).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
  ...
  public void setAdresseIP(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (AdresseIP)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("AdresseIP"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (AdresseIP).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
    m_adresseIP = pValeur;
  ...
  public void setTypeEntite(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (TypeEntite)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("TypeEntite"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (TypeEntite).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
  ...
  public void setIdEntiteAutre(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (idEntiteAutre)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("idEntiteAutre"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (idEntiteAutre).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
  ...
  public void setCodeAntenne(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (CodeAntenne)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("CodeAntenne"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (CodeAntenne).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
  ...
  {
    return m_dateHeureCreation;
  }
  
  public String getDateHeureCreation_C_ERR()
  {
    return m_dateHeureCreation_C_ERR;
  }
  
  public void setDateHeureCreation(Damj pValeur)
  {
    m_dateHeureCreation = pValeur;
  }
  
  public void setDateHeureCreation_C_ERR(String pValeur_C_ERR)
  {
    m_dateHeureCreation_C_ERR = pValeur_C_ERR;
  }
  ...
  public void setSrcCodeTransaction(String pValeur)
  {
    if (pValeur != null)
    {
      ExceptionUtil.assertMethodParamNotNull("pValeur (SrcCodeTransaction)", pValeur, String.class);
      if (pValeur.length() > _getPropertyLength("SrcCodeTransaction"))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut pValeur (SrcCodeTransaction).");
        throw new IndexOutOfBoundsException(t.toString());
      }
    }
  ...
  public Class _getAttributeType(String pPropertyName, String pAttributeName)
  {
    ...
    if ("m_dateHeureCreation_C_ERR".equals(attrName)) {
      return String.class;
    }
    ...
    throws TechniqueException
  {
    ...
    if ("DateHeureCreation".equals(pElementName))
    {
      PropertyInfo info = new PropertyInfo(pElementName, false, false, Damj.class, false);
      return info;
    }
    ...
    throws Exception
  {
    ...
    if ("DateHeureCreation".equals(pName)) {
      return m_dateHeureCreation;
    }
    ...
    throws Exception
  {
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("IdFlux")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut IdFlux.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("ContexteEmission")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut ContexteEmission.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("SrcCodeAssedic")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut SrcCodeAssedic.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("SrcCodeApplication")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut SrcCodeApplication.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("SrcCodeDomaine")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut SrcCodeDomaine.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("SrcCodeProcessus")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut SrcCodeProcessus.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("SrcCodeProgramme")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut SrcCodeProgramme.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("SrcCodeAgent")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut SrcCodeAgent.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("DstCodeAssedic")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut DstCodeAssedic.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("DstCodeApplication")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut DstCodeApplication.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("DstCodeDomaine")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut DstCodeDomaine.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("CodeActivite")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut CodeActivite.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("IdCourantTracker")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut IdCourantTracker.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("IdOrigineTracker")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut IdOrigineTracker.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("IdPrecedentTracker")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut IdPrecedentTracker.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("CodeFlux")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut CodeFlux.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("EnvtNature")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut EnvtNature.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("EnvtBase")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut EnvtBase.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("EnvtServeur")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut EnvtServeur.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("AdresseIP")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut AdresseIP.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("TypeEntite")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut TypeEntite.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("idEntiteAutre")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut idEntiteAutre.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("CodeAntenne")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut CodeAntenne.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    if ("DateHeureCreation".equals(pName)) {
      m_dateHeureCreation = ((Damj)pValeur);
    }
    if ("SrcCodeTransaction".equals(pName))
    {
      if ((pValeur != null) && 
        (((String)pValeur).length() > _getPropertyLength("SrcCodeTransaction")))
      {
        TechniqueException t = new TechniqueException("JXX0100G", "Valeur trop longue pour l'attribut SrcCodeTransaction.");
        throw new IndexOutOfBoundsException(t.toString());
      }
    ...
    throws Exception
  {
    ...
    if ("m_dateHeureCreation_C_ERR".equals(attrName)) {
      m_dateHeureCreation_C_ERR = pValeur;
    }
    if ("m_srcCodeTransaction_C_ERR".equals(attrName)) {
  ...
  {
    if (!(pObjet instanceof _ContexteServiceES)) {
      return false;
    }
    _ContexteServiceES x = (_ContexteServiceES)pObjet;
    if (m_idFlux == null)
    {
      if (m_idFlux != null) {
        return false;
    ...
    else
    {
      ...
      if (!m_dateHeureCreation.equals(m_dateHeureCreation)) {
        return false;
      }
    }
  ...
  public int hashCode()
  {
    ...
    if (m_dateHeureCreation != null) {
      result += m_dateHeureCreation.hashCode();
    }
    if (m_srcCodeTransaction != null) {
  ...
  protected void subToString(StringBuffer pSource)
  {
    ...
    pSource.append(", DateHeureCreation: ");
    pSource.append(m_dateHeureCreation);
    ...
    throws Exception
  {
    ...
    pHandler.property("DateHeureCreation", getDateHeureCreation(), new Attribute[] { new StringAttribute("C_ERR", getDateHeureCreation_C_ERR()) });
    ...
    throws Exception
  {
    ...
    setDateHeureCreation((Damj)pHandler.objectProperty("DateHeureCreation", Damj.class));
    setDateHeureCreation_C_ERR(pHandler.stringAttribute("DateHeureCreation", "C_ERR"));
...
/* Location:
 * Qualified Name:     _ContexteServiceES
