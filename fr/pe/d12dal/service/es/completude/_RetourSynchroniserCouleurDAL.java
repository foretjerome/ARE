...
public class _RetourSynchroniserCouleurDAL
  ...
  implements DataBean, Serializable, Cloneable
{
  ...
  {
    if (!(pObjet instanceof _RetourSynchroniserCouleurDAL)) {
      return false;
    }
    _RetourSynchroniserCouleurDAL x = (_RetourSynchroniserCouleurDAL)pObjet;
  ...
  {
    _RetourSynchroniserCouleurDAL clone_RetourSynchroniserCouleurDAL = new _RetourSynchroniserCouleurDAL();
    clone_RetourSynchroniserCouleurDAL.populateFrom_RetourSynchroniserCouleurDAL(this);
    return clone_RetourSynchroniserCouleurDAL;
  }
  
  public void populateFrom_RetourSynchroniserCouleurDAL(_RetourSynchroniserCouleurDAL pSource)
  {
  ...
  {
    StringBuffer s = new StringBuffer("[_RetourSynchroniserCouleurDAL");
    subToString(s);
    s.append("]");
    return s.toString();
  }
  ...
  {
    return "RetourSynchroniserCouleurDAL";
  }
...
/* Location:
 * Qualified Name:     _RetourSynchroniserCouleurDAL
