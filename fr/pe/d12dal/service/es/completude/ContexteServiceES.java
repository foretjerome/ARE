...
public abstract class ContexteServiceES
{
  public static ContexteServiceES getInstance()
  {
    return new _ContexteServiceESImpl();
  }
  ...
  public abstract Damj getDateHeureCreation();
  
  public abstract void setDateHeureCreation(Damj paramDamj);
  
  public abstract String getCodeErreurDateHeureCreation();
  
  public abstract void setCodeErreurDateHeureCreation(String paramString);
...
/* Location:
 * Qualified Name:     ContexteServiceES
